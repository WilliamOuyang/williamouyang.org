...
<div style={{display:'flex', justifyContent:'center'}}>
  <h1 style={{
    ...
    <ul style={{display:'flex', flexDirection: 'column', gap: '20px'}}>
      ...
      <a href="bitcoin:bc1q7j00jhl0lsnedzz49ph5uraehqhskftke3h69d"><li style={{display:'flex', alignItems:'center'}} className="hover:underline"><img src={BTC} style={{display:'flex', height:'30px', width:'30px', marginRight:'10px', background:'black', borderRadius:'25%', padding:'4px'}}/>Bitcoin Mainnet (bc1q7j00jhl0lsnedzz49ph5uraehqhskftke3h69d)</li></a>

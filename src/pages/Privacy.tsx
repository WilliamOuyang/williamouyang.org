...
const Privacy = () => {
  ...
  return (
    <div>
      ...
      <div style={{display:'flex', justifyContent:'center', marginBottom:'30px'}}><h1 style={{fontFamily:'GT', fontSize:'30px'}} className="cursor-default">About Your Privacy </h1></div>
      <div style={{display:'flex', justifyContent:'center', marginBottom:'30px'}}><h1 style={{fontFamily:'GT', paddingRight:'80px', paddingLeft:'80px'}}>

      

June 26, 2024<br/><br/>

Ouyang Company values its users' privacy. This Privacy Policy ("Policy") will help you understand how we collect and use personal information from those who visit our website or use our online facilities and services, and what we will and will not do with the information we collect. Our Policy has been designed and created to ensure those affiliated with Ouyang Company of our commitment and realization of our obligation not only to meet but to exceed most existing privacy standards.

We reserve the right to make changes to this Policy at any given time. If you want to make sure that you are up to date with the latest changes, we advise you to frequently visit this page. If at any point in time Ouyang Company decides to make use of any personally identifiable information on file, in a manner vastly different from that which was stated when this information was initially collected, the user or users shall be promptly notified by email. Users at that time shall have the option as to whether to permit the use of their information in this separate manner. 

This Policy applies to Ouyang Company, and it governs any data collection and usage by use. Through the use of williamouayng.org, you are therefore consenting to the data collection procedure expressed in this Policy. 

Please note that this Policy does not govern the collection and use of information by companies that Ouyang Company does not control, nor by individuals not employed or managed by us. If you visit a website that we mention or link to, be sure to review its privacy policy before providing the site with information It is highly recommended and suggested that you review the privacy policies and statements of any website you choose to use or frequent to better understand how websites garner, make use of and share the information collected. 
<br/><br/>
...
2. Why we collect personally identifiable information and the legal basis for such <br/>
collection
...
Voluntarily provided information which may
...
In addition,
Ouyang Corporation may have the occasion to collect non-personal
...
emails. This site intends to use personal information only for the
the purpose for which it was requested, and any additional uses specifically
provided for on this Policy. 

<br/><br/>
Why We Collect Information and For How
Long
<br/><br/>
...
To fulfil our legitimate interest in
improving our services and products;

To send you promotional emails containing
information we think you may like when we have your consent to do so;

To contact you to fill out surveys or
participate in other types of market research, when we have your consent to do
so;

To customize our website according to your
online behaviour and personal preferences.

The data we collect from
you will be stored for no longer than necessary. The length of time we retain
said information will be determined based on the following criteria: the
...
Ouyang Corporation does
not now, nor will it in the future, sell, rent or lease any of its customers
lists and/or names to any third parties.

Ouyang Corporation may
collect and make use of personal information to assist in the operation of
our website and to ensure the delivery of the services you need and request. At
...
be available to you from williamouyang.org
...
in other ways described in this Policy or
to which you have otherwise consented;
in the aggregate with other information in
such a way so that your identity cannot reasonably be determined;
as required by law, or in response to a
subpoena or search warrant;
to outside auditors who have agreed to
keep the information confidential;
as necessary to maintain, safeguard and
preserve all the rights and property of Ouyang Corporation.
Ouyang Corporation greatly respects your
...
and/or changes in Ouyang Corporation products and services). In certain circumstances, we may use our
website, newspapers, or other public means to post a notice.
Children under the age of 13
Ouyang Corporation's
...
the alternative, is that verifiable parental consent is obtained for the use and
storage of such information. Anyone under the age of thirteen (13) must seek
and obtain parent or guardian permission to use this website.
Unsubscribe or Opt-Out
All users and visitors to
...
williamouyang@gmx.com. If you wish to unsubscribe or opt out from any
third-party websites, you must go to that specific website to unsubscribe or
opt-out. Ouyang Corporation will continue to adhere to this Policy concerning any personal information previously collected.
Links to Other Websites
Our website does contain
links to affiliates and other websites. Ouyang Corporation does not claim
...
information is encrypted and securely transmitted to us. You can verify
this by looking for a lock icon in the address bar and looking for
"https" at the beginning of the webpage's address. 

While we use encryption
...
authentication and private communications to build user's trust and confidence
...
you are at this moment accepting the terms and conditions stipulated within the Privacy
